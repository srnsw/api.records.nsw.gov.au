class Portfolio < Entity
  ...
  has_and_belongs_to_many :preceding, :class_name => "Portfolio", :join_table => "portfolios_link_preceding"
  has_and_belongs_to_many :succeeding, :class_name => "Portfolio", :join_table => "portfolios_link_succeeding"
